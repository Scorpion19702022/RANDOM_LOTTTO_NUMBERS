const LottoRandomNumbers = () => {
	return (
		<section className='w-[90%] h-[45%] p-[2em] flex flex-col justify-around items-center md:h-[30%]'>
			...
			<div className='w-full h-[25%] flex justify-between items-center md:w-[50%] md:h-[30%]'>
				<button className='w-[40%] h-[50%] border-2 border-gray-200 text-gray-200 cursor-pointer transition duration-300 md:w-[40%] md:h-[70%] lg:w-[45%] hover:bg-gray-800'>
