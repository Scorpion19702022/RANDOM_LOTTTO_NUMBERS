				...
				<button
					...
					className={
						viewBigLottoNumbers.length === 0
							...
							: 'w-[40%] h-full border-2 border-gray-200 text-gray-200 cursor-pointer transition duration-300 bg-gray-800 md:w-[40%] lg:w-[45%] hover:bg-gray-900 shadow-[0px_0px_18px_1px_#00e5e5]'
					}
				>
